...
class FastGradientMethod_LInf(Attack):
    def __init__(self, model, loss_fn, mean, std, max_norm=0.1, random_init=False, targeted=False, num_iter=1):
        norm_type = 'linf'
...
PGD_L2 = IterativeFastGradientMethod_L2
PGD_LInf = IterativeFastGradientMethod_LInf

Noise_LInf = IterativeFastGradientMethod_LInf
Noise_L2 = IterativeFastGradientMethod_L2
